  ...
  return (
    ...
    >
      ...
      >
        ...
        <b>{data?.gatName || "____"}</b> मधील स्थानिक मालमत्ता धारकाचे नाव&nbsp;
        <b>{data?.ownerName || "________________"}</b> मालमत्ता क्रमांक&nbsp;
        <b>{data?.propertyCode || "_________"}</b> मध्ये फेरफार करणेसाठी&nbsp;
        <b>{data?.newOwnerName || "_________"}</b> यांनी महाराष्ट्र महानगरपालिका
        अनुसूची प्रकरण ८ चे नियम १ व २ अन्वये हक्काचे काग‌पत्रासह दिनांक&nbsp;
      ...
      >
        ...
        मालमत्ता श्री / श्रीमती / मे <b>{data?.newOwnerName || "_________"}</b>
        &nbsp;यांचे कडे <b>{data?.documentType || "_________"}</b> या कारणामुळे
        हस्तांतरित झाली आहे, त्याअर्थी प्रशासन अधिकारी,{" "}
      ...
      >
        ...
        समक्ष योग्य त्या कागदपत्रासह लेखी दाखल करावी. मुदतीत हरकत अथवा तक्रार न
        आल्यास वरील नमूदप्रमाणे मालमत्ता हस्तांतरबाबत कार्यवाही केली जाईल, याची
